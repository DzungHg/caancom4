...
<div class="uk-grid uk-child-width-1-1 uk-child-width-1-3@m" data-uk-grid>
    ...
    <div>
        ...
        <div class="in-icon-wrapper small uk-float-left uk-margin-top uk-margin-small-right">
            <img src="<?= $urls->templates ?>assets/images/agivee-icon-content1.png" data-src="<?= $urls->templates ?>assets/images/agivee-icon-content1.png" alt="icon-content1" width="36" height="36" data-uk-img>
        </div>
        ...
        <div class="in-icon-wrapper small uk-float-left uk-margin-top uk-margin-small-right">
            <img src="<?= $urls->templates ?>assets/images/agivee-icon-content2.png" data-src="<?= $urls->templates ?>assets/images/agivee-icon-content2.png" alt="icon-content2" width="36" height="36" data-uk-img>
        </div>
        <div class="uk-overflow-auto uk-margin-small-bottom">
        ...
        <div class="in-icon-wrapper small uk-float-left uk-margin-top uk-margin-small-right">
            <img src="<?= $urls->templates ?>assets/images/agivee-icon-content3.png" data-src="<?= $urls->templates ?>assets/images/agivee-icon-content3.png" alt="icon-content3" width="36" height="36" data-uk-img>
        </div>
        <div class="uk-overflow-auto uk-margin-small-bottom">
